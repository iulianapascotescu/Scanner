...
public class Parser {
    ...
    public Parser(String string, List<String> keywords) {
        this.string = string;
    ...
    public void run() {
        ...
        for (Pair<String, Integer> pair : tokens) {
            ...
            else if (this.isAValidNumber(element) || element.equals("true") || element.equals("false") || (element.charAt(0) == '\'' && element.length() > 1 && element.charAt(element.length() - 1) == '\'' && this.isAValidString(element)) || (element.charAt(0) == '"' && element.length() > 1 && element.charAt(element.length() - 1) == '"' && this.isAValidString(element))) {
